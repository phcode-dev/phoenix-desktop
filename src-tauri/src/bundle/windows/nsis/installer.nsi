...
Section Uninstall
  ...
  ${Else}
    ...
    RMDir "$INSTDIR"
  ${EndIf}
 ; Remove registry entries for .html file associations and context menu
  ...
  ; Remove registry entries for .js file associations and context menu
  ...
  ; Remove registry entries for .css file associations and context menu
