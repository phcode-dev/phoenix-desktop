...
Function AssociateFiles
    ; Push file types and descriptions onto the stack
    Push ".asax"
    Push "ASP.NET Server Application"
    Push ".ashx"
    Push "ASP.NET Web Handler"
    Push ".aspx"
    Push "ASP.NET Server Page"
    Push ".atom"
    Push "Atom Syndication Format"
    Push ".cf"
    Push "ColdFusion"
    Push ".cfc"
    Push "ColdFusion Component"
    Push ".cfm"
    Push "ColdFusion Markup"
    Push ".cfm1"
    Push "ColdFusion Markup (Alternate)"
    Push ".clj"
    Push "Clojure Source File"
    Push ".coffee"
    Push "CoffeeScript"
    Push ".cshtml"
    Push "ASP.NET Razor Web Page"
    Push ".cson"
    Push "CSON Document"
    Push ".css"
    Push "Cascading Style Sheets"
    Push ".ctp"
    Push "CakePHP Template"
    Push ".dhtml"
    Push "Dynamic HTML"
    Push ".diff"
    Push "Diff Output"
    Push ".ejs"
    Push "Embedded JavaScript Template"
    Push ".handlebars"
    Push "Handlebars Template"
    Push ".hbs"
    Push "Handlebars Template"
    Push ".htm"
    Push "HTML Document"
    ...
    Push "HTML Document"
    Push ".hx"
    Push "Haxe Source File"
    Push ".js"
    Push "JavaScript File"
    Push ".json"
    Push "JSON Document"
    Push ".jsp"
    Push "Java Server Page"
    Push ".jsx"
    Push "JSX Script"
    Push ".kit"
    Push "Kit File"
    Push ".less"
    Push "LESS Style Sheet"
    Push ".markdown"
    Push "Markdown Document"
    Push ".mathml"
    Push "MathML Document"
    Push ".md"
    Push "Markdown Document"
    Push ".patch"
    Push "Patch File"
    ...
    Push "PHP 5 Script"
    Push ".phtm"
    Push "PHP-based Web Page"
    Push ".phtml"
    Push "PHP Web Page"
    Push ".rdf"
    Push "Resource Description Framework File"
    Push ".rss"
    Push "RSS Feed"
    Push ".sass"
    Push "SASS Style Sheet"
    Push ".scss"
    Push "SCSS Style Sheet"
    Push ".shtm"
    Push "HTML Document with SSI"
    Push ".shtml"
    Push "HTML Document with SSI"
    Push ".sql"
    Push "SQL Database Script"
    Push ".svg"
    Push "Scalable Vector Graphics"
    Push ".tpl"
    Push "Template File"
    Push ".twig"
    Push "Twig Template"
    Push ".wsgi"
    Push "Python WSGI Script"
    Push ".xbl"
    Push "XML Binding Language File"
    Push ".xht"
    Push "XHTML Document"
    Push ".xhtml"
    Push "XHTML Document"
    ...
    Push "XML Document"
    Push ".xslt"
    Push "XSL Transformation"
    Push ".xul"
    Push "XML User Interface Language File"
    Push ".yaml"
    Push "YAML Document"
    Push ".yml"
    Push "YAML Document"
   ...
   loop:
        ; Attempt to Pop the description
        Pop $0
        ; Check if $0 is empty (description)
        ${If} $0 == ""
            ; If $0 is empty, it means the stack is empty, exit the loop
            Goto loop_end
        ${EndIf}
        ; Attempt to Pop the file extension
        Pop $1

        ; Set file association
        WriteRegStr HKCU "Software\Classes\$1" "" "phcode$1"
        WriteRegStr HKCU "Software\Classes\phcode$1" "" $0
        WriteRegStr HKCU "Software\Classes\phcode$1\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
        WriteRegStr HKCU "Software\Classes\phcode$1\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}.exe" "%1"'
        WriteRegStr HKCU "Software\Classes\phcode$1\shell\phcode" "" "Open with phcode"
        WriteRegStr HKCU "Software\Classes\phcode$1\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}.exe" "%1"'
...
Section Install
  ...
  WriteRegStr HKCU "Software\Classes\phcodeASAX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeASAX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeASAX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeASAX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeASHX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeASHX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeASHX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeASHX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeASPX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeASPX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeASPX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeASPX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeATOM\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeATOM\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeATOM\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeATOM\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCF\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCF\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCF\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCF\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCFC\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCFC\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCFC\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCFC\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCFM\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCFM\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCFM\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCFM\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCFM1\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCFM1\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCFM1\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCFM1\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCLJ\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCLJ\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCLJ\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCLJ\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCOFFEE\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCOFFEE\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCOFFEE\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCOFFEE\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCSHTML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCSHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCSHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCSHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCSON\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCSON\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCSON\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCSON\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCSS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCSS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCSS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeCTP\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeCTP\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeCTP\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeCTP\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeDHTML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeDHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeDHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeDHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeDIFF\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeDIFF\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeDIFF\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeDIFF\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeEJS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeEJS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeEJS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeEJS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeHANDLEBARS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeHANDLEBARS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeHANDLEBARS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeHANDLEBARS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeHBS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeHBS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeHBS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeHBS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeHTM\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeHTM\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeHTM\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeHTM\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeHX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeHX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeHX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeHX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeJS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeJS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeJS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeJSON\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeJSON\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeJSON\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeJSON\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeJSP\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeJSP\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeJSP\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeJSP\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeJSX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeJSX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeJSX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeJSX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeKIT\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeKIT\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeKIT\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeKIT\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeLESS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeLESS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeLESS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeLESS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeMARKDOWN\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeMARKDOWN\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeMARKDOWN\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeMARKDOWN\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeMATHML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeMATHML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeMATHML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeMATHML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeMD\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeMD\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeMD\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeMD\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePATCH\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePATCH\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePATCH\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePATCH\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHP\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHP\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHP\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHP\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHP3\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHP3\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHP3\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHP3\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHP4\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHP4\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHP4\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHP4\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHP5\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHP5\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHP5\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHP5\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHTM\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHTM\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHTM\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHTM\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodePHTML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodePHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodePHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodePHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeRDF\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeRDF\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeRDF\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeRDF\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeRSS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeRSS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeRSS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeRSS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSASS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSASS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSASS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSASS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSCSS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSCSS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSCSS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSCSS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSHTM\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSHTM\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSHTM\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSHTM\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSHTML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSQL\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSQL\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSQL\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSQL\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeSVG\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeSVG\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeSVG\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeSVG\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeTPL\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeTPL\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeTPL\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeTPL\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeTWIG\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeTWIG\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeTWIG\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeTWIG\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeWSGI\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeWSGI\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeWSGI\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeWSGI\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXBL\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXBL\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXBL\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXBL\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXHT\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXHT\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXHT\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXHT\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXHTML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXHTML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXHTML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXHTML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXSLT\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXSLT\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXSLT\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXSLT\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeXUL\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeXUL\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeXUL\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeXUL\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeYAML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeYAML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeYAML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeYAML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeYML\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeYML\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeYML\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeYML\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeTS\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeTS\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeTS\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeTS\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  ...
  WriteRegStr HKCU "Software\Classes\phcodeTSX\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\phcodeTSX\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
  WriteRegStr HKCU "Software\Classes\phcodeTSX\shell\phcode" "" "Open with phcode"
  WriteRegStr HKCU "Software\Classes\phcodeTSX\shell\phcode\command" "" '"$INSTDIR\${MAINBINARYNAME}" "%1"'
...
Section Uninstall
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeASAX\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeASHX\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeASPX\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeATOM\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCF\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCFC\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCFM\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCFM1\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCLJ\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCOFFEE\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCSHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCSON\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCSS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeCTP\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeDHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeDIFF\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeEJS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeHANDLEBARS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeHBS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeHTM\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeHX\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeJS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeJSON\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeJSP\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeJSX\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeKIT\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeLESS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeMARKDOWN\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeMATHML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeMD\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePATCH\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHP\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHP3\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHP4\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHP5\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHTM\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodePHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeRDF\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeRSS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSASS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSCSS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSHTM\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSQL\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeSVG\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeTPL\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeTWIG\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeWSGI\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXBL\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXHT\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXHTML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXSLT\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeXUL\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeYAML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeYML\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeTS\DefaultIcon"
 ...
 DeleteRegKey HKCU "Software\Classes\phcodeTSX\DefaultIcon"
